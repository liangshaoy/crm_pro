# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-06-19 22:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('crmweb', '0002_auto_20190618_1810'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crmweb.ClassList', verbose_name='班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, related_name='students', to='crmweb.ClassList', verbose_name='已报班级')),
                ('customer', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crmweb.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_study_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.ClassStudyRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.Student', verbose_name='学员')),
            ],
        ),
