    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='crmweb.ClassList', verbose_name='已报班级')),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
            fields=[
                ...
                ('delete_status', models.BooleanField(default=False, verbose_name='删除状态')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crmweb.Customer', verbose_name='客户名称')),
                ('enrollment_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crmweb.ClassList', verbose_name='所报班级')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crmweb.Campuses')),
            ],
        ),
    ]
